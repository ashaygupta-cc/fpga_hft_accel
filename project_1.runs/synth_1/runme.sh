...
HD_PWD='C:/Users/ashay_nsjrnqt/OneDrive/Desktop/fpga_hft_accel/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hft_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hft_top.tcl
