...
HD_PWD='C:/Users/ashay_nsjrnqt/OneDrive/Desktop/fpga_hft_accel/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hft_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hft_top.tcl -notrace
